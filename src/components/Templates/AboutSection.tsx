          ...
          <>
            ...
            <div className={'font-light text-brand-greyed'}>
              <p className={'font-light text-current'}>
                Hydranet DAO is an organization focused on developing “abstractive interoperability”. Our key focus is on solutions that allow fundamentally-incompatible blockchains like Bitcoin and Ethereum to interoperate with each other using Layer 3 abstractions.
              ...
              <p className={'mt-3 font-light text-current'}>
                HDX is an Arbitrum token based on the (3,3) Protocol-owned Liquidity model pioneered by OlympusDAO. HDX rewards are generated by bonding funds to the protocol to provide it with further liquidity.
                HDX will additionally serve as the meta-token of our Layer 3 DEX, receiving all fees collected from the Hydranet ecosystem and future DeFi services.
              </p>
            </div>
          </>
        }
