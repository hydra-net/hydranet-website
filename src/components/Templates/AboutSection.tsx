        ...
        <>
          ...
          <div className={'font-light text-brand-greyed'}>
            <p className={'font-light text-current'}>
              Hydranet DAO is a platform focused on Abstractive Interoperability
              – making fundamentally-incompatible decentralized crypto networks
              like Bitcoin and Ethereum talk fluently by way of Layer 3
              abstraction with EVM-centric smart contracts and state channels,
              and Bitcoin/UTXO-based off-chain protocols like the Lightning
              Network.
            </p>
