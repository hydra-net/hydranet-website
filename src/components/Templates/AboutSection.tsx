          ...
          <>
            ...
            <div className={'font-light text-brand-greyed'}>
              ...
              <p className={'mt-3 font-light text-current'}>
                ...
                and DeFi services.” to “HDX rewards are generated by bonding
                funds to the protocol to provide it with further liquidity. HDX
                will additionally serve as the meta-token of our Layer 3 DEX,
                being the end recipient of swaps from trading fees and DeFi
                services.
              </p>
            </div>
          </>
