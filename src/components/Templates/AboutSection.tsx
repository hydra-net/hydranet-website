          ...
          <>
            ...
            <div className={'font-light text-brand-greyed'}>
              <p className={'font-light text-current'}>
                ...
                EVM-centric smart contracts utilizing state channels and
              ...
              <p className={'mt-3 font-light text-current'}>
                ...
                provide it with further liquidity.HDX will additionally serve as
                the meta-token of our Layer 3 DEX, being the end recipient of
